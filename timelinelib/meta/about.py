...
TRANSLATORS = [
    ...
    u"    Waldir Leôncio",
    u"    Miguel Mendes Ruiz",
    u"Catalan:",
    u"    BennyBeat",
    u"    David Vidal i Viladoms",
    u"    whochismo",
    u"Chinese (Simplified):",
    u"    rockxie",
    u"French:",
    u"    Francois Tissandier",
    u"    Arthur Carcano",
    u"    Chapi",
    u"    Cyrille Largillier",
    u"    arnaud81",
    u"German:",
    u"    MixCool",
    u"    Nils Steinger",
    u"    Daniel Winzen",
    u"    Michael F. Schönitzer",
    u"    cmdrhenner",
    u"Hebrew:",
    u"    Yaron Shahrabani",
    u"Italian:",
