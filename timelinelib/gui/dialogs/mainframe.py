...
class MainFrame(wx.Frame):
    ...
    def _create_gui(self):
        ...
        forward_one_week = self.mnu_navigate.Append(wx.ID_ANY, _("Forward One Wee&k"))
        backward_one_week = self.mnu_navigate.Append(wx.ID_ANY, _("Back One &Week"))
        forward_one_month = self.mnu_navigate.Append(wx.ID_ANY, _("Forward One Mont&h"))
        backward_one_month = self.mnu_navigate.Append(wx.ID_ANY, _("Back One &Month"))
        forward_one_year = self.mnu_navigate.Append(wx.ID_ANY, _("Forward One Yea&r"))
        backward_one_year = self.mnu_navigate.Append(wx.ID_ANY, _("Back One &Year"))
        self.mnu_navigate.AppendSeparator()
