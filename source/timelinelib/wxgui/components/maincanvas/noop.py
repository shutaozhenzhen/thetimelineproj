...
class NoOpInputHandler(InputHandler):
    ...
    def mouse_moved(self, x, y, alt_down=False):
        ...
        self._display_eventinfo_in_statusbar(self.last_hovered_event, x, y, alt_down)
    ...
    def _display_eventinfo_in_statusbar(self, event, xpixelpos, ypixelpos, alt_down=False):
