...
* Crash report: WindowsError: [Error 32] The process cannot access the file
...
* | Show point events as symbols
  ...
  | Added an option 'never show paeriod events as point events' to enable
    period events to be displayed as symbols below the divider line.

* | Length of period event is not obvious when zooming out
