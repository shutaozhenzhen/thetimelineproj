...
class FeatureDialogControllerTestCase(UnitTestCase):
...
class describe_feature_dialog_controller(FeatureDialogControllerTestCase):

    def test_can_be_instantiated(self):
        self.assertTrue(self.controller.view)
