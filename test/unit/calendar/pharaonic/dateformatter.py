...
class describe_new_date_formatter(UnitTestCase):
    ...
    def test_can_format_and_parse_with_month_name(self):
        ...
        self.assert_format_parse((2016, 2, 13), (u"2016-⟪II Akhet⟫-13", False))
    ...
    def test_can_get_region_type(self):
        self.assert_region_type_is(("2016-02-13", 0), PharaonicDateFormatter.YEAR)
        self.assert_region_type_is(("2016-02-13", 4), PharaonicDateFormatter.YEAR)
        self.assert_region_type_is(("2016-02-13", 5), PharaonicDateFormatter.MONTH)
        self.assert_region_type_is(("2016-02-13", 7), PharaonicDateFormatter.MONTH)
        self.assert_region_type_is(("2016-02-13", 8), PharaonicDateFormatter.DAY)

    def test_can_get_region_type_for_different_order(self):
        self.formatter.set_region_order(year=2, month=0, day=1)
        self.assert_region_type_is(("02-13-2015", 0), PharaonicDateFormatter.MONTH)
        self.assert_region_type_is(("02-13-2015", 3), PharaonicDateFormatter.DAY)
        self.assert_region_type_is(("02-13-2015", 6), PharaonicDateFormatter.YEAR)

    def test_can_get_region_type_for_abbreviated_month_name(self):
        self.formatter.use_abbreviated_name_for_month(True)
        self.assert_region_type_is(
            (u"2015-⟪II Akhet⟫-10", 16),
            PharaonicDateFormatter.DAY
        )
    ...
    def test_fails_to_parse_if_date_is_invalid(self):
        ...
        self.assertRaises(ValueError, self.formatter.parse, ("2015-13-07", False))
    ...
    def setUp(self):
        ...
        self.formatter = PharaonicDateFormatter()
