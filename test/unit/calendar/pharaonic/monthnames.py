...
class MonthNamesSpec(UnitTestCase):
    ...
    def test_abbreviated_name_for_month_1_should_be_I_Akhet_translated(self):
        self.assertEqual(
            _("I Akhet"),
            timelinelib.calendar.pharaonic.monthnames.abbreviated_name_of_month(1))

    def test_month_from_english_name_thoth_should_be_1(self):
        self.assertEqual(
            1,
            timelinelib.calendar.pharaonic.monthnames.month_from_english_name("Thoth"))

    def test_english_name_for_month_12_should_be_mesori(self):
        self.assertEqual(
            "Mesori",
            timelinelib.calendar.pharaonic.monthnames.english_name_of_month(12))

    def test_abbreviated_name_for_month_12_should_be_IV_Shemu_translated(self):
        self.assertEqual(
            _("IV Shemu"),
            timelinelib.calendar.pharaonic.monthnames.abbreviated_name_of_month(12))

    def test_month_from_english_name_Mesori_should_be_12(self):
        self.assertEqual(
            12,
            timelinelib.calendar.pharaonic.monthnames.month_from_english_name("Mesori"))
