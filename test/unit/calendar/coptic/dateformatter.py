...
class describe_new_date_formatter(UnitTestCase):
    ...
    def test_can_get_region_type(self):
        self.assert_region_type_is(("2016-02-13", 0), CopticDateFormatter.YEAR)
        self.assert_region_type_is(("2016-02-13", 4), CopticDateFormatter.YEAR)
        self.assert_region_type_is(("2016-02-13", 5), CopticDateFormatter.MONTH)
        self.assert_region_type_is(("2016-02-13", 7), CopticDateFormatter.MONTH)
        self.assert_region_type_is(("2016-02-13", 8), CopticDateFormatter.DAY)

    def test_can_get_region_type_for_different_order(self):
        self.formatter.set_region_order(year=2, month=0, day=1)
        self.assert_region_type_is(("02-13-2015", 0), CopticDateFormatter.MONTH)
        self.assert_region_type_is(("02-13-2015", 3), CopticDateFormatter.DAY)
        self.assert_region_type_is(("02-13-2015", 6), CopticDateFormatter.YEAR)

    def test_can_get_region_type_for_abbreviated_month_name(self):
        self.formatter.use_abbreviated_name_for_month(True)
        self.assert_region_type_is(
            (u"2015-⟪II Akhet⟫-10", 16),
            CopticDateFormatter.DAY
        )
    ...
    def setUp(self):
        ...
        self.formatter = CopticDateFormatter()
