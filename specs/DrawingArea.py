...
class DrawingAreaSpec(unittest.TestCase):
    ...
    def test_construction_works(self):
        self.view.SetBackgroundColour.assert_called_with(wx.WHITE)
        self.view.SetBackgroundStyle.assert_called_with(wx.BG_STYLE_CUSTOM)
        self.view.set_default_cursor.assert_called()
        self.view.Disable.assert_called()
        self.view.edit_ends.assert_called()
    ...
    def setUp(self):
        ...
        self.controller = DrawingArea(self.view, status_bar_adapter, config, self.drawing_algorithm, divider_line_slider, fn_handle_db_error)
